...
LRESULT CALLBACK InfoWindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        CreateWindowEx(0, "STATIC", "Ошаров Фёдор, ЭВМб-22-1", WS_CHILD | WS_VISIBLE | SS_CENTER,
...
void Init()
{
    ...
    Menu_AddButton("Id", 20, 90, 200, 60, 4);
    Menu_AddButton("Running", 20, 160, 200, 60, 4);
    Menu_AddButton("Stopping", 20, 230, 200, 60, 4);
    Menu_AddButton("Exit", 20, 300, 200, 60, 4);


    textureSprite1 = LoadTexture("waiting.png");
    textureSprite2 = LoadTexture("running.png");
    textureSprite3 = LoadTexture("stopping.png");
}
